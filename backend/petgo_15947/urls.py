...
admin.site.site_header = "PetGo"
admin.site.site_title = "PetGo Admin Portal"
admin.site.index_title = "PetGo Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="PetGo API",
        default_version="v1",
        description="API documentation for PetGo App",
    ),
    public=True,
